...
const en = {
  ...
  phone: {
    ...
    helper:
      'AmiShop uses a phone number to verify each account. We will never share this information with a third party.',
  ...
  add: {
    home: {
      ...
      desc:
        'Add your business on the AmiShop map.||Attract cryptocurrency holders to your shop.',
      not_enough_money: ({ minEth, minDth }) =>
        `You must have at least ${minEth.toFixed(
          4,
        )} ETH and ${minDth} AMIS to add a shop`,
  ...
  shop_recap: {
    ...
    closed: 'closed',
    licence_price: ({ price }) => `**Licence price**: ${price} AMIS`,
  },
  categories: {
    0: 'Groceries',
    1: 'Clothes Shop',
  ...
  show_shop: {
    transaction_pending:
      'We are deleting your shop from the AmiShop map, it can take few minutes...',
    delete_button: 'Delete Shop',
    submit_button: 'Submit',
    loader_title: 'Please wait',
    loader_delete_message: 'We are deleting your shop from the AmiShop map...',
    shop_appear_shortly: 'Your shop will appear shortly on the map',
  },
  add_form_verification: {
    transaction_pending:
      'We are adding your shop on the AmiShop map, it can take few minutes...',
    submit_button: 'Submit',
    edit_button: 'Edit',
    loader_title: 'Please wait',
  ...
  beta_send: {
    title: 'Warning!',
    text:
      'Congratulations! Your shop might take a couple minutes to appear on the AmiShop map. Click on your metamask to see your transaction status.',
    button: 'Ok',
  },
  beta_receive: {
    title: 'Warning!',
    text:
      'Your shop might take a couple minutes to disappear from the AmiShop map. Click on your metamask to see your transaction status.',
    button: 'Ok',
  },
  map: {
    shop_card: {
  ...
  notifications: {
    ...
    shop_added:
      "Congratulations! You've added a shop. You're on your way to being listed on the AmiShop map! It might take a few moments to appear on the map–just hang tight!",
    transaction_pending:
