...
\
**LEXCOM CONSULT OÜ** is a company incorporated and registered in Estonia with registration number 14470241 and is the distributor and operator of Dether Platform and is the creator of a decentralized platform aimed at enabling smartphone users to buy and sell cryptocurrency using cash and spend it in physical stores listed on the Dether Map (the "Dether Platform"). There may be other entities within the Dether group of companies from time to time ("Dether Companies") that will manage and/or operate the Dether Platform (or parts thereof) and references in these Terms to "Dether", "Company", "we", "our" or "us" shall be to **LEXCOM CONSULT OÜ**, the Dether Companies and their respective successors and assigns.||||\
\
